...
void protobuf_AssignDesc_initialize_2eproto() {
  ...
  static const int BINInitializeRequest_offsets_[8] = {
  ...
  static const int BINInitializeResponse_offsets_[11] = {
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_pakageName;
        break;
      }
